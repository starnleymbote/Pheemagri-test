...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Pheemagri | Landing, Corporate &amp; Business Templatee</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 bg-light opacity-85" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img class="d-inline-block align-top img-fluid" src="assets/img/gallery/logo-icon.png" alt="" width="50" /><span class="text-theme font-monospace fs-4 ps-2">Pheemagri</span></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <form class="d-flex">
                ...
                <a href="{{ route('register') }}" class="text-sm text-gray-700 dark:text-gray-500 underline" style="margin-left:10px">Sign in</a>
              {{-- <button class="btn btn-lg btn-dark bg-gradient order-0" href="{{ route('login') }}">Sign Up</button> --}}
              {{-- <button class="btn btn-lg btn-dark bg-gradient order-0" style="margin-left:5px" href="{{ route('login') }}" >Login</button> --}}
            </form>
          </div>
        </div>
      </nav>
